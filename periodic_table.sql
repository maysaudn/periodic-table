...
--
-- Name: elements name_unqiue; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements symbol_unqiue; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT symbol_unqiue UNIQUE (symbol);
